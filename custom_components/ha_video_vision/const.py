"""Constants for HA Video Vision integration - VIDEO ONLY."""
...
PROVIDER_NAMES: Final = {
    ...
    PROVIDER_OPENROUTER: "OpenRouter (Nemotron)",
}
...
DEFAULT_FACIAL_REC_ENABLED: Final = True
...
DEFAULT_CAMERAS: Final = {
    "camera1": {"channel": "01", "friendly_name": "Camera 1", "ha_entity": ""},
}
